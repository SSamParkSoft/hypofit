...
final class AdminSupportRequestParser {
    ...
    static String parseKindFilter(String raw) {
        if (raw == null) {
            return null;
        }
    ...
    static Boolean parseDeletedByUserFilter(String raw) {
        if (raw == null) {
            return null;
        }
        return switch (raw) {
    ...
    static AdminSupportService.AdminSupportStatusUpdateCommand parseStatusUpdate(AdminSupportTicketStatusUpdateRequest payload) {
        return parseStatusUpdate(RawRequestBodyJson.toJsonNode(payload.rawBody()));
    }

    static AdminSupportService.AdminSupportStatusUpdateCommand parseStatusUpdate(JsonNode payload) {
    ...
    static AdminSupportService.AdminSupportReplyCommand parseReply(AdminSupportTicketReplyCreateRequest payload) {
        return parseReply(RawRequestBodyJson.toJsonNode(payload.rawBody()));
    }

    static AdminSupportService.AdminSupportReplyCommand parseReply(JsonNode payload) {
        JsonNode object = requireObject(payload);
        List<FieldError> errors = new ArrayList<>();
