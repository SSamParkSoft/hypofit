package com.contentruck.hypofit.accountdeletion.dto;
...
import com.contentruck.hypofit.accountdeletion.service.AccountDeletionVerificationReadModel;
...
public final class AccountDeletionWebModels {
    ...
    public record PublicCreateRequest(
        ...
        public PublicCreateCommand toCommand() {
    ...
    public record AuthenticatedCreateRequest(
        ...
        public AuthenticatedCreateCommand toCommand() {
    ...
    public record ResendRequest(
        ...
        public ResendCommand toCommand() {
    ...
    public record ConfirmRequest(
        ...
        public ConfirmCommand toCommand() {
    ...
    public record AccountDeletionRequestResponse(
        ...
        public static AccountDeletionRequestResponse from(AccountDeletionRequestReadModel model) {
    ...
    public record PublicAccountDeletionRequestResponse(
        ...
        public static PublicAccountDeletionRequestResponse from(AccountDeletionRequestReadModel model) {
    ...
    public record AccountDeletionVerificationResponse(
        ...
        public static AccountDeletionVerificationResponse from(AccountDeletionVerificationReadModel model) {
    ...
    public record PublicAccountDeletionVerificationResponse(
        ...
        public static PublicAccountDeletionVerificationResponse from(AccountDeletionVerificationReadModel model) {
