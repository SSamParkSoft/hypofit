...
import com.contentruck.hypofit.user.service.UserReadRepository;
...
public class UserReadRepositoryAdapter implements UserReadRepository {
    ...
    public UserProfileRecord saveProfile(UserProfileMutation mutation) {
        ...
        entity.setOrganizationType(mutation.organizationType());
        entity.setOrganizationName(mutation.organizationName());
