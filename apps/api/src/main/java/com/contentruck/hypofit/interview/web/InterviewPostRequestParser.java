...
import com.contentruck.hypofit.interview.application.InterviewPostUpdateCommand;
...
final class InterviewPostRequestParser {
    ...
    static InterviewPostCreateCommand parseCreate(InterviewPostCreateRequest body) {
        return parseCreate(RawRequestBodyJson.toJsonNode(body.rawBody()));
    }

    static InterviewPostCreateCommand parseCreate(JsonNode body) {
    ...
    static InterviewPostUpdateCommand parseUpdate(InterviewPostUpdateRequest body) {
        return parseUpdate(RawRequestBodyJson.toJsonNode(body.rawBody()));
    }

    static InterviewPostUpdateCommand parseUpdate(JsonNode body) {
        JsonNode object = requireObject(body);
        List<FieldError> errors = new ArrayList<>();
    ...
    static void parseCloseStatus(InterviewPostStatusUpdateRequest body) {
        parseCloseStatus(RawRequestBodyJson.toJsonNode(body.rawBody()));
    }

    static void parseCloseStatus(JsonNode body) {
        JsonNode object = requireObject(body);
