...
final class AdminSupportWebModels {

    private AdminSupportWebModels() {
    }

    record SupportTicketEventResponse(
            UUID id,
        ...
        static SupportTicketEventResponse from(AdminSupportRepository.SupportTicketEventRecord event) {
    ...
    record SupportTicketReplyResponse(
            UUID id,
            @JsonProperty("ticket_id") UUID ticketId,
            String message,
            @JsonProperty("created_at") OffsetDateTime createdAt
    ...
    record AdminSupportTicketResponse(
            UUID id,
        ...
        static AdminSupportTicketResponse from(AdminSupportService.AdminSupportTicketView view) {
