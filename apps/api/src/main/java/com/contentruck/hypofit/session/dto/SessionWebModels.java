...
public final class SessionWebModels {
    ...
    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    public static final class UpdateSessionRequest {
    ...
    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    public record RewardDisputeRequest(
            @Schema(types = {"null", "string"})
    ...
    public record InterviewSessionResponse(
        ...
        public static InterviewSessionResponse from(SessionReadModels.InterviewSessionReadModel model) {
    ...
    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    public record ConfirmAttendanceResponse(
            InterviewSessionResponse session,
            AttendanceRecordResponse attendance
    ) {
        public static ConfirmAttendanceResponse from(SessionReadModels.ConfirmAttendanceReadModel model) {
    ...
    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    public record RewardConfirmationResponse(
            UUID id,
            @JsonProperty("session_id") UUID sessionId,
            @JsonProperty("application_id") UUID applicationId,
        ...
        public static RewardConfirmationResponse from(SessionReadModels.RewardConfirmationReadModel model) {
    ...
    public record InterviewReviewResponse(
        ...
        public static InterviewReviewResponse from(SessionReadModels.InterviewReviewReadModel model) {
