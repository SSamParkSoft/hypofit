...
final class AccountDeletionCleanupPolicy {

    static final String PROFILE_IMAGE_BUCKET = "profileimage";
    ...
    static String normalizeProfileImagePath(String profileImagePath) {
