...
import com.contentruck.hypofit.admin.service.AdminModerationActionCommand;
...
public final class AdminModerationRequestParser {
    ...
    public static AdminModerationActionCommand parse(AdminModerationActionCreateRequest payload) {
        return parse(RawRequestBodyJson.toJsonNode(payload.rawBody()));
    }

    public static AdminModerationActionCommand parse(JsonNode payload) {
