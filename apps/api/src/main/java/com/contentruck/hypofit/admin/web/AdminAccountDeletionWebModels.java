...
import com.contentruck.hypofit.accountdeletion.application.AccountDeletionService.AdminAccountDeletionRequestView;
import com.fasterxml.jackson.annotation.JsonProperty;
import io.swagger.v3.oas.annotations.media.Schema;
import java.time.OffsetDateTime;
import java.util.UUID;

final class AdminAccountDeletionWebModels {

    private AdminAccountDeletionWebModels() {
    }

    record AdminAccountDeletionRequestResponse(
            UUID id,
        ...
        static AdminAccountDeletionRequestResponse from(AdminAccountDeletionRequestView view) {
