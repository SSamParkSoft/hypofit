...
import com.contentruck.hypofit.session.application.SessionContexts.AttendanceRecord;
import com.contentruck.hypofit.session.application.SessionContexts.InterviewPostRecord;
import com.contentruck.hypofit.session.application.SessionContexts.InterviewReviewRecord;
import com.contentruck.hypofit.session.application.SessionContexts.InterviewSessionRecord;
import com.contentruck.hypofit.session.application.SessionContexts.RewardConfirmationRecord;
import com.contentruck.hypofit.session.application.SessionContexts.SessionContext;
import com.contentruck.hypofit.session.application.SessionContexts.StoredUser;
import com.contentruck.hypofit.session.application.SessionReadModels.ApplicationReadModel;
import com.contentruck.hypofit.session.application.SessionReadModels.AttendanceRecordReadModel;
import com.contentruck.hypofit.session.application.SessionReadModels.ConfirmAttendanceReadModel;
import com.contentruck.hypofit.session.application.SessionReadModels.InterviewReviewReadModel;
import com.contentruck.hypofit.session.application.SessionReadModels.InterviewSessionReadModel;
import com.contentruck.hypofit.session.application.SessionReadModels.RewardConfirmationReadModel;
import com.contentruck.hypofit.session.application.SessionReadModels.UserSummary;
...
public class SessionWorkflowService {
    ...
    public List<InterviewSessionReadModel> listSessions(UUID userId) {
        return repository.listSessionRows(userId)
                .stream()
